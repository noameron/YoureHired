...
Display real-time research agent progress during drill generation via a swipeable carousel UI.
...
### Requirement: Drill Card Output

The existing drill card display remains unchanged. All drill card styling, layout, and functionality continues to work as currently implemented.
