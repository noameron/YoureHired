...
C#, Ruby, Kotlin, Swift, Scala, PHP, R, etc.
- Frameworks: React, Angular, Vue, Django, Flask, Spring, .NET,
Rails, Express, Next.js, FastAPI, etc.
- Tools: Docker, Kubernetes, AWS, GCP, Azure, Terraform, Jenkins,
Git, PostgreSQL, MongoDB, Redis, Kafka, etc.
