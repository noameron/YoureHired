...
- Use the tech stack and engineering culture from context, but only reference well-known, real technologies (e.g. Python, Java, JavaScript, Go, AWS, Kubernetes, etc.). Ignore any tech stack entries that are not recognized real-world technologies.
{SECURITY_RULES}"""
